...
object DataModule {
    ...
    @Provides
    internal fun provideCategoryDao(database: IdbDataBase): CategoryDao{
        return database.categoryDao()
    }

    @Provides
    internal fun provideMovieDao(database: IdbDataBase): MovieDao{
        return database.movieDao()
    }

    @Provides
    internal fun provideActorDao(database: IdbDataBase): ActorDao{
